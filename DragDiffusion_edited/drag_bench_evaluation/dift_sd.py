...
class SDFeaturizer:
    ...
    def forward(self, 
        ...
        # Updated encode_prompt handling
        ...
        prompt_embeds = prompt_embeds_tuple[0]  # Extract embeddings tensor

        # Ensure prompt_embeds is repeated correctly for the ensemble
        prompt_embeds = prompt_embeds.repeat(ensemble_size, 1, 1)

        # Call the OneStepSDPipeline
        unet_ft_all = self.pipe(
            img_tensor=img_tensor,
            t=t,
            up_ft_indices=[up_ft_index],
